...
export class ChatService {
    ...
    getGroupsDetails() {
        return this.http.get(apiBaseURL + "getGroupDetails?user_id=" + localStorage.getItem("user_id"));
      }

      getGroupMessages(groupId:number,offset:number) {
        return this.http.get(apiBaseURL + "getMessages?group_id=" + groupId + "&offset=" + offset);
      }

      deleteMessage(id: number) {
        return this.http.delete(apiBaseURL + "deleteMessage/" + id);
      }
    
      addMessage(message: any) {
        return this.http.post(apiBaseURL + "insertMessage", message);
      }
